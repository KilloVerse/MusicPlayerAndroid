...
import com.example.try10.databinding.SelectionSongListRecyclerRowBinding
...
class SectionSongListAdapter(private val songIdList:List<String>):
    ...
    class MyViewHolder(private val binding:SelectionSongListRecyclerRowBinding):RecyclerView.ViewHolder(binding.root){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val binding=SelectionSongListRecyclerRowBinding.inflate(LayoutInflater.from(parent.context),parent,false)
